...
reg = lm(dataSeq$Time ~ dataSeq$Size * log(dataSeq$Size))  # Let's compare time to O(n log(n)) of the size
...
The up-left plot is a good sign, as it seems like overall we have a line around $0$.\
The Q-Q also seems to confirm that our model fits well.
